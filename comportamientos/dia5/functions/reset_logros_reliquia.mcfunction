...
tag @s remove completo1
tag @s remove completo2
tag @s remove completo3
tag @s remove completo4
tag @s remove logroinfernal

scoreboard players set @s itemsgets 0