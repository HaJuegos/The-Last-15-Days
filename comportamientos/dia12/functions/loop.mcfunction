...
execute as @e[type=item,name="The Sneaky Astroner Helmet"] run tag @s add fireprote
execute as @e[type=item,name="The Sneaky Astroner Chestplate"] run tag @s add fireprote
execute as @e[type=item,name="The Sneaky Astroner Leggings"] run tag @s add fireprote
execute as @e[type=item,name="The Sneaky Astroner Boots"] run tag @s add fireprote
execute as @e[type=item,name="Casco del Astronauta Cauteloso"] run tag @s add fireprote
execute as @e[type=item,name="Coraza del Astronauta Cauteloso"] run tag @s add fireprote
execute as @e[type=item,name="Musleras del Astronauta Cauteloso"] run tag @s add fireprote
execute as @e[type=item,name="Botas del Astronauta Cauteloso"] run tag @s add fireprote

tag @e[type=ender_crystal,tag=!playerCrystal] add naturalGenerated
clear @a potato
