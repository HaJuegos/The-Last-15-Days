...
tellraw @a {"rawtext": [{"translate": "chat.infernal_relic_get", "with": {"rawtext": [{"selector": "@s"}]}}]}
execute as @a at @s run playsound ambient.weather.thunder

tag @s add getInfernal