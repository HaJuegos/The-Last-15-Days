...
execute as @a[tag=!getTusk,hasitem={item=ha:hoglin_tusk}] at @s run function achievements/hoglin_tusk
...
execute as @e[tag=!fireOff,type=item,name="§hCautious Astronaut Helmet§r"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="§hCasco del Astronauta Cauteloso§r"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="item.ha:sneaky_helmet"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="item.ha:sneaky_helmet.name"] at @s run tag @s add fireOff

execute as @e[tag=!fireOff,type=item,name="§hCautious Astronaut Chestplate§r"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="§hPechera del Astronauta Cauteloso§r"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="item.ha:sneaky_chestplate"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="item.ha:sneaky_chestplate.name"] at @s run tag @s add fireOff

execute as @e[tag=!fireOff,type=item,name="§hCautious Astronaut Leggigns§r"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="§hPantalones del Astronauta Cauteloso§r"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="item.ha:sneaky_leggings"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="item.ha:sneaky_leggings.name"] at @s run tag @s add fireOff

execute as @e[tag=!fireOff,type=item,name="§hCautious Astronaut Boots§r"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="§hBotas del Astronauta Cauteloso§r"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="item.ha:sneaky_boots"] at @s run tag @s add fireOff
execute as @e[tag=!fireOff,type=item,name="item.ha:sneaky_boots.name"] at @s run tag @s add fireOff